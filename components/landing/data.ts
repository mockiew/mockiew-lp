...
export const FEATURES = [
  ...
  {
    layout: 'left' as const,
    tag: 'Iterative Learning',
    tagColor: '#16a34a',
    title: 'Build Confidence Over Time',
    desc: 'Track your progress across multiple sessions and watch your scores improve steadily.',
    points: [
  ...
  },
  {
    ...
    tagColor: '#9333ea',
    title: 'Nail The Hard Questions',
    desc: 'Focus specifically on behavioral, technical, or curveball questions that trip you up.',
    points: [
